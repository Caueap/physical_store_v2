import { IsBoolean, IsEmail, IsMongoId, IsNumber, IsOptional, IsString } from 'class-validator';
import { Type } from 'class-transformer';
import { ApiProperty } from '@nestjs/swagger';

export class UpdatePdvDto {
  @ApiProperty({ description: 'The name of the PDV', example: 'Updated PDV Name', required: false })
  @IsOptional()
  @IsString()
  storeName?: string;

  @ApiProperty({ description: 'The ID of the store that this PDV belongs to', example: '60a1e2c5c5e4b02f68c15a1c', required: false })
  @IsOptional()
  @IsMongoId()
  store?: string;
